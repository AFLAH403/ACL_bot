...
PICS = (environ.get('PICS', 'https://telegra.ph/file/2b8d372791e46a46fc2db-464ac23ab13badca30.jpg')).split()
...
DEFAULT_AUTH_CHANNELS = [int(x) for x in environ.get("AUTH_CHANNEL", "-1002661445312").split() if x.lstrip('-').isdigit()]
